...
from models.GateDetectionFCN.GateDetection import GateDetection
...
def gate_detect_init(
    vgg_config, upsample_mode, batch_norm, print_summary=False, pretrained=True
):
...
gate_detection = gate_detect_init("vgg-11", "8s", True)


img = cv2.imread("testImages/000552.png")
print(img)
